"""
Day 12 AI Application - Voice Agent (Speech → LLM → Text)
Voice-driven AI agent with speech-to-text using OpenAI Whisper
"""
import os
import logging
import threading
...
if __name__ == '__main__':
    ...
    logger.info(f"Day 12 - Voice Agent running on http://{host}:{port}")
    print(f"Day 12 - Voice Agent (Speech → LLM → Text) running on http://{host}:{port}")
