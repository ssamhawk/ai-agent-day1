"""
Day 13 AI Application - Voice Agent + Document Indexing
Voice-driven AI agent with speech-to-text and document indexing with semantic search
"""
import os
import logging
import threading
...
if __name__ == '__main__':
    ...
    logger.info(f"Day 13 - Voice Agent + Document Indexing running on http://{host}:{port}")
    print(f"Day 13 - Voice Agent + Document Indexing running on http://{host}:{port}")
