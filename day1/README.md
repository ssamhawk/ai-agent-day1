# AI Agent - Day 1 Challenge

A smart AI agent that answers questions through a modern web interface, powered by OpenAI GPT-4o-mini.
...
| `FLASK_PORT` | `5001` | Server port (Day 1) |
...
This project is part of the AI Agent Challenge - Day 1.
